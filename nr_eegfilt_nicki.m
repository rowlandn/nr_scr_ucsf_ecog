% eegfilt_nicki() -  (high|low|band)-iass filter data using two-way least-squares 
...
function [smoothdata,filtwts] = eegfilt_nicki(data,srate,locutoff,hicutoff,epochframes,filtorder, revfilt)
