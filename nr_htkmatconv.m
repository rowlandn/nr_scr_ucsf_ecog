function nr_htkmatconv(htkmatconv_otpt_filename,M1_ch1,M1_ch2,ipad_filename,chan_dat,htkmatstruct_file_dir)

nr_aomatstruct_ipad(aomatconv_filename,M1_ch,ipad_filename,aomatstruct_file_dir)
...
save(filename,'name','ecog','M1_ch1','M1_ch2','chan_dat','aux','emg','Fs');
