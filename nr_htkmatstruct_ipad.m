function nr_htkmatstruct_ipad(htk_dir,htkmatstruct_otpt_filename,M1_ch1,M1_ch2,ipad_filename,aux_lbl,htkmatstruct_file_dir,anl_dir)
...
name = [htkmatstruct_otpt_filename(1:11),'str_',htkmatstruct_otpt_filename(12:end),'_ecog.mat'];
...
cd(htkmatstruct_file_dir)

save(name,'name','ecog','M1_ch1','M1_ch2','aux','emg','Fs','thresh','auxchan_lbl');
